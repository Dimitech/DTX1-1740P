...
//#define CKGR_PLLAR_Val  0x20270804			// for MCK=120MHz osc=12MHz, DivA=4, MULA=39 (PLL MUL=MULA+1)) MCK= PLL/2.
#define CKGR_PLLAR_Val  0x20190803			// for 100MHz osc=12MHz, DivA=3, MULA=49 (PLL MUL=MULA+1) MCK= PLL/2.
#define CKGR_PLLBR_Val  0x00000600			// 0x00170604      // 0x00003F00
#define PMC_MCKR_Val    0x00000002			// 0x00000002      // 0x00000001
